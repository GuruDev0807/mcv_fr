  ...
  return (
    <Table className="garage table w-full text-xs sm:text-[9px] text-white uppercase">
      <Thead className="w-full ">
        <Tr className="text-[#33D4FF] tracking-[0.5px] table table-fixed w-full text-shadow-blue">
          ...
          <Th className="px-0.5">
            ...
            >
              <div
                className={
                  selectedSort.value === "earn" ? "font-bold text-white" : null
                }
              >
                daily earn
              </div>
          ...
          <Th className="px-0.5">
            ...
            >
              <div
                className={
                  selectedSort.value === "claim" ? "font-bold text-white" : null
                }
              >
                to claim
              </div>
            ...
            className={`${
              selectedCarInfo
                ? selectedCarInfo.id === item.id
                  ...
                  : null
                : null
            } border-[#153A51] border-b-[0.5px] last:border-0 border-opacity-70 hover:bg-[#21C6FA] hover:bg-opacity-30 table table-fixed w-full cursor-pointer`}
            key={`car_${index}`}
