...
const GarageGridView = ({
  ...
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-3 3xl:grid-cols-4">
      {nfv.map((item, index) => (
        <div
          className={
            selectedCarInfo
              ? selectedCarInfo.id === item.id
                ? "relative bg-gradient-to-b from-[rgba(255,174,0,0.5)] to-[rgba(4,36,45,0.5)] border border-[#FFAE00] rounded mt-5"
                : "relative bg-gradient-blue hover:bg-[#23D0FF] hover:bg-opacity-20 border border-[#80C9FF] rounded mt-5 cursor-pointer"
              : null
          }
          key={`car_${index}`}
        ...
        >
          ...
          <div className="p-2.5">
              ...
              className={`${
                selectedCarInfo
                  ? selectedCarInfo.id === item.id
                    ...
                    : "border-white"
                  : null
              } border border-white bg-[#D9D9D9] rounded-[3px] relative`}
            >
              <img
            ...
            <div className="mt-2">
              <div className="flex justify-between gap-1 py-0.5">
                <div className="text-[9px] leading-3 text-white text-opacity-60">
                  Earning
                </div>
              ...
              <div className="flex justify-between gap-1 py-0.5">
                ...
                <div className="font-bold text-[10px] leading-3 text-right tracking-[0.5px] text-[#23D0FF]">
          ...
          <div className="grid grid-cols-2">
            <button
              className="bg-[#23D0FF] rounded-bl-[3px] flex justify-center items-center gap-0.5 py-2"
              onClick={() => handleClaim()}
            >
              <img
                src={Images.iconActionBankBlack}
                alt=""
                className="w-4 h-4"
              />
              <div className="text-[10px] font-bold leading-3 text-center tracking-[0.5px] text-black">
                CLAIM
              </div>
            </button>
            <button className="bg-black rounded-br-[3px] flex justify-center items-center gap-0.5 py-2">
              ...
              <div className="text-[10px] leading-3 text-center tracking-[0.5px] text-white">
                MARKET
              </div>
            </button>
          </div>
