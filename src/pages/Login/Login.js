    ...
    <>
      <div className="hidden py-32 main md:block">
        ...
        <div className="absolute md:top-[3.5vh] lg:top-[5vh] left-1/2 -translate-x-1/2 flex items-center gap-2">
          ...
          <div
            className="md:text-base lg:text-[20px] font-semibold text-[#00A3FF]  uppercase tracking-widest"
        ...
        <div className="flex items-center justify-center w-full h-[calc(100vh-16rem)]">
          <div className="connect-wallet  text-center uppercase w-[600px]">
            <div
              className="text-[#009EFF] font-semibold text-2xl tracking-[2.7px] pt-14 pb-8"
              style={{ textShadow: "0px 0p 5px #FFFFFF" }}
            >
              please connect your wallet
            </div>
            <div className="w-1/2 h-px border-t border-dashed border-[#009EFF] mx-auto"></div>
              ...
              {({ account, chain, mounted, openConnectModal, openChainModal }) => {
                ...
                return (
                  <>
                    {!connected ? (
                      <div
                        className="w-fit text-[#FFD900] font-bold text-2xl tracking-[1px] border border-solid hover:bg-yellow-400 hover:bg-opacity-20 border-[#FFD900] rounded-tr-[10px] rounded-bl-[10px] cursor-pointer py-6 px-9 my-9 mx-auto"
            ...
            <div className="w-3/5 text-sm text-[#009EFF] tracking-[1.5px] mx-auto mb-10">
        ...
        <div className="absolute left-1/2 bottom-[1vh] w-3/5 -translate-x-1/2 flex items-center">
          <a
            ...
            target={"_blank"}
            rel="noreferrer"
            className="text-[10px] text-[#33D4FF]  tracking-[2px] uppercase text-shadow-blue"
          >
            mcverse.app
          </a>
      ...
      >
        <div className="w-full h-[100vh] flex items-center justify-center">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 flex items-center w-[90vw] h-10 text-center">
            <div
              className="text-sm font-semibold text-[#FFD900]  uppercase tracking-widest w-full"
              style={{ textShadow: "0px 0px 5px rgba(0, 128, 255, 0.98)" }}
            >
              welcome to mcverse
            </div>
          ...
          <div className="connect-wallet  text-center uppercase w-[90vw]">
            ...
            <div className="w-3/5 min-w-[250px] text-sm text-[#00E0FF] tracking-[1.5px] mx-auto mb-10">
              make sure you connect your metamask to the avalanche network
            </div>
          </div>
        </div>
